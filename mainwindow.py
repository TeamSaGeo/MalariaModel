...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.groupBox_col_export.sizePolicy().hasHeightForWidth())
        self.groupBox_col_export.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setBold(True)
        self.groupBox_col_export.setFont(font)
        self.groupBox_col_export.setStyleSheet("")
        self.groupBox_col_export.setAlignment(QtCore.Qt.AlignmentFlag.AlignLeading|QtCore.Qt.AlignmentFlag.AlignLeft|QtCore.Qt.AlignmentFlag.AlignVCenter)
        ...
        self.gridLayout_9.setContentsMargins(-1, 6, -1, 4)
        self.gridLayout_9.setVerticalSpacing(3)
        self.gridLayout_9.setObjectName("gridLayout_9")
        self.groupBox = QtWidgets.QGroupBox(parent=self.groupBox_col_export)
        self.groupBox.setObjectName("groupBox")
        self.gridLayout_7 = QtWidgets.QGridLayout(self.groupBox)
        self.gridLayout_7.setObjectName("gridLayout_7")
        self.ah = QtWidgets.QCheckBox(parent=self.groupBox)
        font = QtGui.QFont()
        font.setPointSize(9)
        font.setBold(False)
        self.ah.setFont(font)
        self.ah.setObjectName("ah")
        self.gridLayout_7.addWidget(self.ah, 1, 0, 1, 1)
        self.adultestot = QtWidgets.QCheckBox(parent=self.groupBox)
        font = QtGui.QFont()
        font.setPointSize(9)
        font.setBold(False)
        self.adultestot.setFont(font)
        self.adultestot.setObjectName("adultestot")
        self.gridLayout_7.addWidget(self.adultestot, 4, 0, 1, 1)
        self.ahI = QtWidgets.QCheckBox(parent=self.groupBox)
        font = QtGui.QFont()
        font.setPointSize(9)
        font.setBold(False)
        self.ahI.setFont(font)
        self.ahI.setObjectName("ahI")
        self.gridLayout_7.addWidget(self.ahI, 3, 0, 1, 1)
        self.ahE = QtWidgets.QCheckBox(parent=self.groupBox)
        font = QtGui.QFont()
        font.setPointSize(9)
        font.setBold(False)
        self.ahE.setFont(font)
        self.ahE.setObjectName("ahE")
        self.gridLayout_7.addWidget(self.ahE, 2, 0, 1, 1)
        self.gridLayout_9.addWidget(self.groupBox, 2, 1, 1, 1)
        self.groupBox_2 = QtWidgets.QGroupBox(parent=self.groupBox_col_export)
        ...
        self.humE = QtWidgets.QCheckBox(parent=self.groupBox_2)
        font = QtGui.QFont()
        font.setPointSize(9)
        font.setBold(False)
        self.humE.setFont(font)
        self.humE.setObjectName("humE")
        self.gridLayout_8.addWidget(self.humE, 1, 0, 1, 1)
        self.humS = QtWidgets.QCheckBox(parent=self.groupBox_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.humS.sizePolicy().hasHeightForWidth())
        self.humS.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setPointSize(9)
        font.setBold(False)
        self.humS.setFont(font)
        self.humS.setObjectName("humS")
        self.gridLayout_8.addWidget(self.humS, 0, 0, 1, 1)
        self.humI = QtWidgets.QCheckBox(parent=self.groupBox_2)
        font = QtGui.QFont()
        font.setPointSize(9)
        font.setBold(False)
        self.humI.setFont(font)
        self.humI.setObjectName("humI")
        self.gridLayout_8.addWidget(self.humI, 2, 0, 1, 1)
        self.humR = QtWidgets.QCheckBox(parent=self.groupBox_2)
        font = QtGui.QFont()
        font.setPointSize(9)
        font.setBold(False)
        self.humR.setFont(font)
        self.humR.setObjectName("humR")
        self.gridLayout_8.addWidget(self.humR, 3, 0, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.tabWidget, 2, 0, 1, 7)
        ...
        self.gridLayout_4.addWidget(self.logo_app, 1, 0, 1, 7)
        ...
        self.logo_minsan.setLayoutDirection(QtCore.Qt.LayoutDirection.LeftToRight)
        ...
        self.gridLayout_4.addWidget(self.logo_minsan, 0, 1, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.logo_pmi, 0, 3, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.logo_ipm, 0, 5, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.groupBox.setTitle(_translate("MainWindow", "Vecteurs"))
        self.ah.setText(_translate("MainWindow", "adultes femelles à la recherche d\'hôte"))
        self.adultestot.setText(_translate("MainWindow", "total adultes femelles"))
        self.ahI.setText(_translate("MainWindow", "adultes femelles infectées à la recherche d\'hôte"))
        self.ahE.setText(_translate("MainWindow", "adultes femelles exposées à la recherche d\'hôte"))
        self.groupBox_2.setTitle(_translate("MainWindow", "Humains"))
